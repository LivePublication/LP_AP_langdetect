...
description = ActionProviderDescription(
    globus_auth_scope="https://auth.globus.org/scopes/c41e7d4b-d519-4fb1-b7b3-5e9054389cb0/action_provider_operations",
    title="langdetect",
    admin_contact="ael56@uclive.ac.nz",
    synchronous=True,
    input_schema=ActionProviderInput,
    api_version="1.0",
    subtitle="langdetect Action Provider",
    description="Executes the langdetect library to classify the langauge line by line of a text file.",
    keywords=["langdetec", "LID", "Library", "Language Identification", "Text Classification"],
    visible_to=["public"],
